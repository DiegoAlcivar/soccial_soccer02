            ...
            <div class="row">
                ...
                <div class="col s12 m10">
                    <div class="nav-wrapper">
                        <a href="index.php" class="brand-logo"> <i class="large licon material-icons left">school</i> Social Soccer </a>
...
-->
     ...
     <!-- MODAL QUE MUESTRA EL FORMULARIO DE LOGIN PARA LOS DIFERENTES USUARIOS -->
        ...
        <footer class="page-footer blue-grey lighten-1">
            <div class="container">
                2023 Dil.alcivar@yavirac.edu.ec
            <a class="grey-text text-lighten-4 right" href="#!"> Yavirac </a>
            </div>
        </footer>
